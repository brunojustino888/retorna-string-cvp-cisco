 ...
 */
public class VerbalizaTempo2 extends ActionElementBase implements ElementInterface 
{
...
public ArrayList Padrao(){
	...
	if(strArray[0].length()== 1){
		...
		if(strArray[0].equals("1") || strArray[0].equals("2"))
		{
			strArray[0] = "00"+strArray[0]; 
		}
	...
	if(strArray[0].length()== 2 ){
		...
		//Verifica se existe se iremos ter que tocar audios com variação de masculino ou feminino no questão de tempo
		// Ex: 22:00 ficará assim : 022T.wav e.wav Horas.wav
		if(strArray[0].substring(1).equals("1") || strArray[0].substring(1).equals("2"))
				{
					strArray[0] = strArray[0]+"T"; 
				}
	...
	if(strArray[0].length()== 1 ){
		...
		if(strArray[0].substring(0).equals("1") || strArray[0].substring(0).equals("2"))
				{
					strArray[0] = strArray[0]+"T"; 
				}
...
public ArrayList Normal(){
	...
	if (strArray[0].equals("001")||strArray[0].equals("01")||strArray[0].equals("1")||strArray[0].equals("002")||strArray[0].equals("02")||strArray[0].equals("2") ){
...
public ArrayList ApenasHoras(){
	...
	strLista.add("vazio.wav");
		...
		if (strRetorno.equals("1") || strRetorno.equals("01")|| strRetorno.equals("001")|| strRetorno.equals("2")|| strRetorno.equals("02")|| strRetorno.equals("002"))
		{
			strRetorno = strRetorno+"T";
		}
		
	    //Verifica o tamanho da String
		if (strRetorno.length() == 2){
			
			if(strRetorno.substring(1).equals("1") || strRetorno.substring(1).equals("2"))
	...
	if(strRetorno.contains("T")){
		
		if(strRetorno.length()==4){
		strLista.add(strRetorno+".wav");
		strLista.add(HourHours()+".wav");
		}else if(strRetorno.length()==3){
		strLista.add("0"+strRetorno+".wav");
		strLista.add(HourHours()+".wav");
		}else if(strRetorno.length()==2){
		strLista.add("00"+strRetorno+".wav");
		strLista.add(HourHours()+".wav");
		}
		
	} else {
	
		if(strRetorno.length()==3){
		strLista.add(strRetorno+".wav");
		strLista.add(HourHours()+".wav");
		}else if(strRetorno.length()==2){
		strLista.add("0"+strRetorno+".wav");
		strLista.add(HourHours()+".wav");
		}else if(strRetorno.length()==1){
		strLista.add("00"+strRetorno+".wav");
		strLista.add(HourHours()+".wav");
		}	
	}
	...
	public String HoraHoras(){
		if(   (strArray[0].equals("001"))||(strArray[0].equals("1")||strArray[0].equals("001T")||strArray[0].equals("01T")||strArray[0].equals("1T")) ){
			return "Hora";
		}else{
			return "Horas";
		}
	...
	public String MinutoMinutos(){
		if(   (strArray[1].equals("001"))||(strArray[1].equals("1"))||(strArray[1].equals("01")||(strArray[1].equals("001T"))||(strArray[1].equals("01T"))||(strArray[1].equals("1T"))) ){
			return "Minuto";
		}else{
			return "Minutos";
		}
	...
	public String HourHours(){
		if( (strRetorno.equals("1") || strRetorno.equals("01") || strRetorno.equals("001")||strRetorno.equals("1T") || strRetorno.equals("01T") || strRetorno.equals("001T"))){
			return "Hora";
		}else{
			return "Horas";
		}
